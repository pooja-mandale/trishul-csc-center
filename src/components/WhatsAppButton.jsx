...
const WhatsAppButton = () => {
  const phoneNumber = '916306121646';
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-[0_10px_25px_rgba(37,211,102,0.4)] flex items-center justify-center transition-colors group"
    ...
    >
      ...
      <span className="hidden md:inline mr-2 font-bold text-sm relative z-10">Chat with Us</span>
